...
from utils.utils_100 import get_training_dataloader, get_test_dataloader, WarmUpLR
...
if __name__ == '__main__':
    ...
    for xunhuan in range(0, 5):
        ...
        net = ResNet56(depth=56, num_classes=100, dist_prob=args.dist_prob, block_size   =args.block_size, alpha=args.alpha, nr_steps=len(training_loader) * args.epochs).cuda()
